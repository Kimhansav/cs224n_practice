...
class CharCorruptionDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        masked_index = int(torch.randint(low = 0, high = truncated_len - masked_len + 1, size = (1,))[0])

        prefix = truncated_doc[:masked_index]
        suffix = truncated_doc[masked_index + masked_len:]
        masked_content = truncated_doc[masked_index:masked_index + masked_len]
