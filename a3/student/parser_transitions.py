...
def minibatch_parse(sentences, model, batch_size):
    ...
    #partial_parses는 PartialParse(sentences)를 initialize한 뒤 리스트인데 이 리스트는 뭘 담고 있는가? self.sentence? self.stack? self.buffer? self.dependencies?
    unfinished_parses = partial_parses[:]
    ...
    while unfinished_parses :
        ...
        for i, transition in enumerate(transitions) :
            ...
            #partial_parses -> unfinished_parses -> minibatch, minibatch[i].parse_step. 이때 dependency 등 처리한 결과물은 누구 것으로 저장됨?
